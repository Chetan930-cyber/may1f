...
const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-6 bg-gradient-to-r from-yellow-200 via-pink-200 to-blue-200">
      ...
      <div className="absolute top-20 left-20 w-32 h-32 bg-pink-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
      <div className="absolute top-40 right-20 w-32 h-32 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
      <div className="absolute bottom-20 left-1/2 w-32 h-32 bg-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
        ...
        <div className="bg-white bg-opacity-20 backdrop-blur-lg p-8 rounded-2xl shadow-2xl border border-white border-opacity-30">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              >
                <input
                  ...
                  required
                  className="w-full p-4 bg-white bg-opacity-70 border-2 border-pink-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent placeholder-pink-300 text-pink-800 font-medium text-lg shadow-md"
                />
              </motion.div>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              disabled={isLoading}
              className="w-full py-4 px-6 mt-8 bg-gradient-to-r from-pink-500 via-pink-400 to-blue-400 text-white text-xl font-bold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              {isLoading ? (
          ...
          <div className="mt-8 text-center">
            <p className="text-blue-800">
              ...
              <motion.a
                ...
                className="font-bold text-pink-600 hover:text-pink-800 underline transition-colors"
                href="/signup"
              >
                Sign up
              </motion.a>
