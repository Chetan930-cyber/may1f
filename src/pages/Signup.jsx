    ...
    <div className="flex items-center justify-center min-h-screen p-6 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500">
      ...
      <div className="relative z-10 w-full max-w-md fade-in-animation">
        ...
        <div className="backdrop-blur-md bg-white/30 p-8 rounded-2xl shadow-2xl border border-white/30">
          <div className="scale-in-animation mb-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="input-container">
                <input
                  ...
                  required
                  className="w-full p-4 bg-white/50 border-2 border-white/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent placeholder-gray-600 text-gray-800 font-medium text-lg shadow-md transition-transform hover:scale-[1.01] focus:scale-[1.02]"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 px-6 mt-8 bg-gradient-to-r from-purple-600 to-indigo-600 text-white text-xl font-bold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed hover:scale-[1.03] active:scale-[0.98]"
            >
              {isLoading ? (
          ...
          <div className="mt-8 text-center">
            <p className="text-white text-lg font-medium drop-shadow-sm">
              ...
              <a
                className="font-bold text-indigo-200 hover:text-white underline transition-colors hover:scale-105"
                href="/login"
              >
                Log in
              </a>
